...
% Simple replacement for siunitx's \numrange
\newcommand{\numrange}[2]{#1--#2}
...
on Zenodo (https://doi.org/10.5281/zenodo.17835088).
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-phy1-1.eps}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-phy2-1.eps}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-strapp-1.eps}}
