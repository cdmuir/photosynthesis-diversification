...
Data availability statement: Data are available from previously published sources. The code to reproduce analyses is available on GitHub (https://github.com/cdmuir/photosynthesis-diversification) and archived on Zenodo.
